...
export default function AddressesScreen() {
  ...
  const styles = useMemo(() => createStyles(palette, insets, isRTL), [palette, insets, isRTL]);
  ...
  return (
    <BottomSheetModalProvider>
      <Screen>
        <View style={{ justifyContent: 'space-between', flex: 1, paddingBottom: insets.bottom + 10 }}>
          <View>


            {!(editing || adding) && <Text weight="bold" style={styles.title}>
              ...
              ListEmptyComponent={
                <View style={{ alignItems: 'center', paddingTop: 100 }}>
                  <LottieView
                    ...
                    source={require("../assets/noAddresses.json")}
                  />
          ...
          <View style={{ gap: 10 }}>
            {!(editing || adding) ? (<View>
              ...
              <View>
                ...
                {(editing || adding) && (
                  <TouchableOpacity style={{ alignItems: 'center', padding: 10 }} onPress={resetForm}>
                    <Text weight="bold" style={styles.link}>{t("cancel") ?? "Cancel"}</Text>
                  </TouchableOpacity>
                )}
              </View>
            )}
...
const createStyles = (palette: any, insets: any, isRTL: boolean) =>
  StyleSheet.create({
    ...
    sheetContainer: { padding: 16, gap: 10, paddingBottom: insets.bottom + 10 },
