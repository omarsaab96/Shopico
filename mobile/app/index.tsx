...
import { FlatList, Button, Text, TextInput, View, StyleSheet, Image, TouchableOpacity, ActivityIndicator, Keyboard } from "react-native";
      ...
      <Screen>
        ...
        <View style={styles.searchWrapper}>
          ...
          {searching ? (
            ...
            search.trim() &&
            <AntDesign name="close" size={20} color={isDark ? 'white' : "black"} style={styles.searchSpinner} onPress={() => { setSearch(''); Keyboard.dismiss() }} />
          )}
        </View>
        ...
        <Text style={styles.section}>
          {hasQuery
            ? `${t("products")} (${filteredAndSorted.length})`
            : t("freshPicks")}
        </Text>
        <FlatList
        ...
        {hasQuery ? (
          <Text style={styles.searchMeta}>
            ...
            {filteredAndSorted.length == 0 && t("emptyProducts")}
          </Text>
        ) : null}
      </Screen>
...
const createStyles = (palette: any, isRTL: boolean) =>
  StyleSheet.create({
    ...
    sheetContainer: {
      paddingHorizontal: 16, paddingBottom: 100, flex: 1
    },
