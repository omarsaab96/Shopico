...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    accountCheckFailed: "Could not check this account",
    close: "Close",
    delete: "Delete",
    ...
    "perm.users.roles.manager.view": "View manager users",
    "perm.users.roles.staff.view": "View staff users",
    "perm.users.roles.driver.view": "View driver users",
    "perm.users.roles.customer.view": "View customer users",
    "perm.users.roles.manager.create": "Create manager users",
    "perm.users.roles.staff.create": "Create staff users",
    "perm.users.roles.driver.create": "Create driver users",
    "perm.users.roles.customer.create": "Create customer users",
    ...
    "perm.currencies.view": "View currencies",
    "perm.currencies.manage": "Manage currencies",
    ...
    searchCurrencies: "Search symbol",
    "currencySymbol.SYP": "SYP",
    ...
    bulkUpdateCategory: "Update category",
    clearSelection: "Clear selection",
    selectProductsFirst: "Select products first",
    selectCategoryFirst: "Select a category first",
    selectedProductsCount: "Selected products",
    confirmCategoryUpdate: "Confirm category update",
    categoryWillChangeTo: "Category will change to",
    ...
    symbol: "Symbol",
    symbolEn: "English symbol",
    symbolAr: "Arabic symbol",
    ...
    levelsLabel: "Membership levels by currency",
    "level.silver": "Silver",
    "level.gold": "Gold",
  ...
  ar: {
    bulkUpdateCategory: "تحديث التصنيف",
    ...
    accountCheckFailed: "تعذر التحقق من هذا الحساب",
    close: "إغلاق",
    delete: "حذف",
    ...
    "perm.users.create": "إنشاء المستخدمين",
    "perm.users.roles.manager.view": "عرض مستخدمي المدير",
    "perm.users.roles.staff.view": "عرض مستخدمي الموظفين",
    "perm.users.roles.driver.view": "عرض مستخدمي السائقين",
    "perm.users.roles.customer.view": "عرض مستخدمي العملاء",
    "perm.users.roles.manager.create": "إنشاء مستخدمي المدير",
    "perm.users.roles.staff.create": "إنشاء مستخدمي الموظفين",
    "perm.users.roles.driver.create": "إنشاء مستخدمي السائقين",
    "perm.users.roles.customer.create": "إنشاء مستخدمي العملاء",
    ...
    searchCurrencies: "ابحث بالرمز",
    "currencySymbol.SYP": "ل.س",
    "currencySymbol.USD": "د.أ",
    ...
    symbol: "الرمز",
    symbolEn: "الرمز بالإنجليزية",
    symbolAr: "الرمز بالعربية",
    exchangeRate: "سعر الصرف",
    primaryCurrency: "العملة الأساسية",
    setPrimary: "تعيين كأساسية",
    confirmDeleteCurrency: "هل تريد حذف هذه العملة؟",
    ...
    levelsLabel: "مستويات العضوية حسب العملة",
    "level.silver": "فضي",
    "level.gold": "ذهبي",
...
const translationOverrides: Record<Language, Record<string, string>> = {
  en: {
    ...
    passwordSetupTokenRequired: "A valid password setup link is required.",
    passwordSetupLink: "Password setup link",
    passwordSetupLinkHint: "Send this one-time link to the user. It expires in 7 days.",
    copy: "Copy",
    ...
    "audit.by": "by",
    "audit.for": "for",
    "audit.adminTopupRequest": "Admin created top-up request",
    "audit.type": "Type",
    "audit.actor": "Actor",
    "audit.action": "Action",
    "audit.result": "Result",
    ...
    branchesRequiredTitle: "Create a branch to continue",
    branchesRequiredBody: "Start by adding a new branch to manage this data.",
    branchesRequiredNoAccess: "You do not have permission to manage branches. Ask an admin to create or assign one.",
  ...
  ar: {
    bulkUpdateCategory: "تحديث التصنيف",
    clearSelection: "مسح التحديد",
    selectProductsFirst: "حدد المنتجات أولا",
    selectCategoryFirst: "حدد تصنيفا أولا",
    selectedProductsCount: "المنتجات المحددة",
    confirmCategoryUpdate: "تأكيد تحديث التصنيف",
    categoryWillChangeTo: "سيتم تغيير التصنيف إلى",
    currentCategory: "التصنيف الحالي",
    confirm: "تأكيد",
    close: "إغلاق",
    cancel: "إلغاء",
    ...
    "audit.by": "بواسطة",
    "audit.for": "لـ",
    "audit.adminTopupRequest": "أنشأ المسؤول طلب شحن",
    "audit.type": "النوع",
    "audit.actor": "من قام بالإجراء",
    ...
    branchesRequiredTitle: "أنشئ فرعًا للمتابعة",
    branchesRequiredBody: "ابدأ بإضافة فرعًا جديداً لإدارة هذه البيانات.",
    branchesRequiredNoAccess: "ليس لديك صلاحية إدارة الفروع. اطلب من مسؤول إنشاء فرع أو ربطك بفرع.",
