...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "perm.wallet.view": "View wallet top-ups",
    ...
    showChangesOnly: "Show only changes",
    reason: "Reason",
    action: "Action",
    importSummary: "Created {created}, updated {updated}, skipped {skipped} of {total}.",
    importPreviewSummary: "Preview: {created} new, {updated} updates, {skipped} skipped of {total}.",
