...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    "perm.users.about.view": "View user about section",
    "perm.users.about.manage": "Manage user about section",
    "perm.users.ledger.view": "View user ledger section",
    "perm.users.ledger.manage": "Manage user ledger section",
    "perm.users.branches.view": "View user branches section",
    "perm.users.branches.manage": "Manage user branches section",
    "perm.users.permissions.view": "View user permissions section",
    "perm.users.permissions.manage": "Manage user permissions section",
    // navigation
    ...
    savePermissions: "��� ���������",
    permissionsUpdated: "�� ����� ���������",
    passwordSetupHint: "\u0633\u064a\u0642\u0648\u0645 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645 \u0628\u062a\u0639\u064a\u064a\u0646 \u0643\u0644\u0645\u0629 \u0645\u0631\u0648\u0631 \u0639\u0646\u062f \u0623\u0648\u0644 \u062a\u0633\u062c\u064a\u0644 \u062f\u062e\u0648\u0644.",
    noPermissionTitle: "�� ���� ���",
    noPermissionBody: "��� ���� ������ ���� ��� ������.",
    noPermissionAction: "�� ���� ���",
